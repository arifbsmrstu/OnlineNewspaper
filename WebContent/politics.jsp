                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="recent_blog">
                                ...
                                <%
			                    	try{ 
			                    		Connection connection6=(Connection)application.getAttribute("MyConn");
									Statement statement6=connection6.createStatement();
									String sql ="SELECT * FROM onp_news where category='Politics'";
									
									ResultSet resultSet6 = statement6.executeQuery(sql);
                                ...
                                <div class="recent_post fix">
                                    <h1><%=resultSet6.getString("title") %></h1>
                                    
                                    <img src="GetImage?title=<%=resultSet6.getString("title") %>" alt="image">
                                    <p class="post_by">Posted by <%=resultSet6.getString("username") %> on <%=resultSet6.getString("date") %> </p>
                                    <p class="post_summary">
                                    <%
			                        	String detail = resultSet6.getString("details");
                                    ...
                                    <a href="post_view.jsp?title=<%=resultSet6.getString("title") %>">Read More</a>
