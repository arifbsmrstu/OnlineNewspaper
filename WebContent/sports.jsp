                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="recent_blog">
                                ...
                                <%! ResultSet resultSet12;String tit;%>
                                <%
                                 
			                    	try{ 
			                    		Connection connection10=(Connection)application.getAttribute("MyConn");
									Statement statement10=connection10.createStatement();
									String sql ="SELECT * FROM onp_news where category='Sports'";
									
									resultSet12 = statement10.executeQuery(sql);
									while(resultSet12.next()){
										tit=resultSet12.getString("title");
                                ...
                                <div class="recent_post fix">
                                    ...
                                    <img src="GetImage?title=<%=tit %>" alt="image">
                                    <p class="post_by">Posted by <%=resultSet12.getString("username") %> on <%=resultSet12.getString("date") %> %> </p>
                                    <p class="post_summary">
                                    <%
			                        	String detail = resultSet12.getString("details");
                                    ...
                                    <a href="post_view.jsp?title=<%=resultSet12.getString("title") %>">Read More</a>
