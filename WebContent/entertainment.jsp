                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="recent_blog">
                                ...
                                <%
			                    	try{ 
			                    	Connection connection3=(Connection)application.getAttribute("MyConn");
									Statement statement3=connection3.createStatement();
									String sql ="SELECT * FROM onp_news where category='Entertainment'";
                                ...
                                <div class="recent_post fix">
                                    <h1><%=resultSet3.getString("title") %></h1>
                                    
                                    <img src="GetImage?title=<%=resultSet3.getString("title") %>" alt="image">
                                    <p class="post_by">Posted by <%=resultSet3.getString("username") %> on <%=resultSet3.getString("date") %> </p>
                                    <p class="post_summary">
                                    <%
			                        	String detail = resultSet3.getString("details");
                                    ...
                                    <a href="post_view.jsp?title=<%=resultSet3.getString("title") %>">Read More</a>
